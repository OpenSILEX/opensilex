...
/**
 * Corresponds to the submitted JSON for the GET actuators
 * @author Morgane Vidal <morgane.vidal@inra.fr>
 */
public class ActuatorDetailDTO extends AbstractVerifiedClass {
    //uri of the actuator
    private String uri;
    ...
    public ActuatorDetailDTO(Actuator actuator) {
        uri = actuator.getUri();
        ...
        variables = new HashMap<>(actuator.getVariables());
    }
