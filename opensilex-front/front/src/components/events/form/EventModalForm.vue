...
en:
    Event:
        ...
        list-title: Associated events
        is-instant: Instantaneous event
        is-instant-help: Indicate if the event is instantaneous or has a duration
        event: Event
        creator: Creator
...
fr:
    Event:
        ...
        list-title: "Évenement(s) associé(s)"
        is-instant: "Événement instantané"
        is-instant-help: Indique si l'évenement est instantané ou a une durée
        event: Évenement
        creator: Créateur
