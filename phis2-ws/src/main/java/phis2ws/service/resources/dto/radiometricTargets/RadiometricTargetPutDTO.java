...
import phis2ws.service.resources.dto.PropertiesLabelDTO;
import phis2ws.service.view.model.phis.RadiometricTarget;

/**
 * Represents the JSON for the update of a radiometric target.
 * @see PropertiesLabelDTO
