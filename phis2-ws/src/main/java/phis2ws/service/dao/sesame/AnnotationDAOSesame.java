...
public class AnnotationDAOSesame extends DAOSesame<Annotation> {
    ...
    final static String TRIPLESTORE_RELATION_MOTIVATEDBY = NAMESPACES.getRelationsProperty("rMotivatedBy");

    // Search parameters
    // uri of an annotation eg.
    public String uri;
    public static final String URI = "uri";
    // Creation date of and annotation eg. http://www.phenome-fppn.fr/platform/id/annotation/8247af37-769c-495b-8e7e-78b1141176c2
    public String created;
    public static final String CREATED = "created";
    // Comment that describe the annotation eg. Ustilago maydis infection
    ...
    /**
     * Query generated by the searched parameters above
     *
