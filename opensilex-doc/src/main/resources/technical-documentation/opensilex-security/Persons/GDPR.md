...
Paths of GDPR files are written in the security part of the config. You can declare as many file as you want, in relation with its redaction language. See [GDPR_config.md](/src/main/resources/installation/configuration/GDPR_config.md).
...
For configuration instructions see [GDPR_config.md](/src/main/resources/installation/configuration/GDPR_config.md).