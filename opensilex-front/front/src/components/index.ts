...
import ScientificObjectProperties from './scientificObjects/ScientificObjectProperties.vue';
components["opensilex-ScientificObjectProperties"] = ScientificObjectProperties;
