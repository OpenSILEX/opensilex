 ...
 */
@Service
public class ObservationDAO extends MongoReadWriteDao<ObservationModel, ObservationSearchFilter> {
    ...
    public ObservationDAO(MongoDBServiceV2 mongodb) {
        super(mongodb, ObservationModel.class, COLLECTION_NAME, CREATE_URI_PATH);
    }
}
