...
> see the [versioning notes](https://github.com/OpenSILEX/opensilex/blob/master/opensilex-doc/src/main/resources/release/1.?.?.md).
> Also available [locally](opensilex-doc/src/main/resources/release/1.?.?.md).
