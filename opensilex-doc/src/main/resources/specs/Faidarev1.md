...
| commonCropName string	Common name for the crop (MCPD)                                                                                                                                                          | species name             |                    |
...
| synonyms array\[string\]	List of alternative names or IDs used to reference this germplasm                                                                                                                     | synonyms                 |                    |
...
| trialDbId	string	The ID which uniquely identifies a trial                                                                                           |                                                                                                                       | Notion doesn't really exist in OpenSILEX                                                                      |
