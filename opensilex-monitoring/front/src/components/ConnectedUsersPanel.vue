...
import type { ConnectedUserDTO } from '../lib/model/connectedUserDTO';
...
const shown = computed<ConnectedUserDTO[]>(() => props.accounts.slice(0, 6));
//#endregion
...
//#region Methods
function displayName(account: ConnectedUserDTO): string {
