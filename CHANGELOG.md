...
- (!1346) [Data] Creating a data with a NA value from web-service no longer throws an exception

## [1.4.4]

### Fixed or optimized

- (!1344) [Data] Creating a data with a datafile prov_used now works again
...
- (!1337) [GlobalUriSearch] Fixed the uri search box not popping up on instances with a unique header.
