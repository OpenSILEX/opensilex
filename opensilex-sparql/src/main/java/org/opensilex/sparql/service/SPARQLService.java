...
public class SPARQLService implements SPARQLConnection, Service, AutoCloseable {
    ...
    public void startup() throws Exception {
        setDefaultLang(OpenSilex.getDefaultLanguage());
        connection.startup();
    }
    ...
    public <T extends SPARQLResourceModel> void delete(Node graph, Class<T> objectClass, URI uri, boolean deleteAllReverseReferences) throws Exception {
        try {
            ...
            if (deleteAllReverseReferences) {
                ...
                Iterator<Map.Entry<Class<? extends SPARQLResourceModel>, Field>> i = SPARQLClassObjectMapper.getReverseReferenceIterator(objectClass);
                ...
                while (i.hasNext()) {
                    ...
                    SPARQLClassObjectMapper<SPARQLResourceModel> reverseMapper = SPARQLClassObjectMapper.getForClass(entry.getKey());
