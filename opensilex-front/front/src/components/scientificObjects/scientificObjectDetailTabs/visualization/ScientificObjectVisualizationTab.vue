...
import {DataGetDTO, DataService, EventsService,} from "core/index";
import HttpResponse, {OpenSilexResponse} from "core/HttpResponse";
import {DataFileGetDTO} from "core/model/dataFileGetDTO";
import {Image} from "../visualization/image";
import {VariablesService} from "core/api/variables.service";
import {AnnotationGetDTO} from "core/model/annotationGetDTO";
...
import {ProvEntityModel} from "core/model/provEntityModel";
import OpenSilexVuePlugin from "../../models/OpenSilexVuePlugin";
import { inject, ref } from "vue";

//#region Used Interfaces & types
...
const variablesService: VariablesService = $opensilex.getService("opensilex.VariablesService");
const annotationService: AnnotationsService = $opensilex.getService("opensilex.AnnotationsService");
...
const eventCreatedTime = ref<string>("");
const form;
const selectedVariable = ref<string>(null);
//#endregion
