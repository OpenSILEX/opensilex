...
//******************************************************************************
package org.opensilex.phis.geneticResource.api;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.junit.Test;
import org.opensilex.core.geneticResource.api.BaseGeneticResourceAPITest;
...
import org.opensilex.core.geneticResource.api.GeneticResourceGetSingleDTO;
...
public class GeneticResourceAPITest extends BaseGeneticResourceAPITest {
    ...
    public void CreatedVarietyShouldHaveASpecies() throws Exception {
        ...
        geneticResourceDTO.setRdfType(URI.create(Oeso.Variety.getURI()));
        geneticResourceDTO.setSpecies(null);
    ...
    public void SpeciesShouldBeAutomaticallyRetrievedWhenVarietyIsGiven() throws Exception {
        GeneticResourceCreationDTO baseSpecies = getCreationSpeciesDTO();
        final URI baseSpeciesURI = new UserCallBuilder(create)
                .setBody(baseSpecies)
                .buildAdmin()
                .executeCallAndReturnURI();

        GeneticResourceCreationDTO variety = getCreationVarietyDTO(baseSpeciesURI);
        final URI varietyURI = new UserCallBuilder(create)
                .setBody(variety)
                .buildAdmin()
                .executeCallAndReturnURI();

        GeneticResourceCreationDTO geneticResourceWithVariety = getCreationSpeciesDTO();
        geneticResourceWithVariety.setVariety(varietyURI);
        final URI createdURI = new UserCallBuilder(create)
                .setBody(geneticResourceWithVariety)
                .buildAdmin()
                .executeCallAndReturnURI();

        final GeneticResourceGetSingleDTO geneticResourceDTO = new UserCallBuilder(get)
                .addPathTemplateParam("uri", createdURI)
                .buildAdmin()
                .executeCallAndDeserialize(new TypeReference<SingleObjectResponse<GeneticResourceGetSingleDTO>>() {
        })
                .getDeserializedResponse()
                .getResult();

        assertEquals("When creating the 'geneticResourceWithVariety' geneticResource, the API should have automatically added the baseSpecies linked to the given variety",
                SPARQLDeserializers.getShortURI(baseSpeciesURI),
                SPARQLDeserializers.getShortURI(geneticResourceDTO.getSpecies()) );
    }
    ...
    public void testUpdate() throws Exception {
        ...
        // create a Variety
        GeneticResourceCreationDTO variety = getCreationVarietyDTO(species);
        ...
        // retrieve the new geneticResource and compare to the expected geneticResource
        ...
        GeneticResourceGetSingleDTO dtoFromApi = getResponse.getResult();
    ...
    @Test
    public void UpdatedGeneticResourceShouldHaveASpecies() throws Exception {
        GeneticResourceCreationDTO speciesDTO = getCreationSpeciesDTO();
        ...
        geneticResourceToUpdateDTO.setRdfType(URI.create(Oeso.Accession.toString()));
        geneticResourceToUpdateDTO.setSpecies(speciesURI);
        final URI createdURI = new UserCallBuilder(create)
                .setBody(geneticResourceToUpdateDTO)
                .buildAdmin()
                .executeCallAndReturnURI();

        geneticResourceToUpdateDTO.setUri(createdURI);
        geneticResourceToUpdateDTO.setSpecies(null);
    ...
    public void testDelete() throws Exception {
        ...
        GeneticResourceCreationDTO speciesNotToDelete = getCreationSpeciesDTO();
