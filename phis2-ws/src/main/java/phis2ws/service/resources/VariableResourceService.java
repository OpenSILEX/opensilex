...
public class VariableResourceService extends ResourceService {
    ...
    public Response getVariablesBySearch(
        ...
        @ApiParam(value = "Search by skos trait reference", example = DocumentationAnnotation.EXAMPLE_TRAIT_URI) @QueryParam("traitSKosReference") @URL String traitSKosReference,
