...
//        }
        ...
        String inputSpecName = configurator.getInputSpec();
        if (inputSpecName == null || !(new File(inputSpecName).exists())) {
            getLog().info("Swagger file doesn't exists, code generation skipped: " + inputSpecName);
