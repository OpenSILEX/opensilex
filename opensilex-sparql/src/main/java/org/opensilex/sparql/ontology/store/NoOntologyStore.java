...
public class NoOntologyStore implements OntologyStore {
    ...
    @Override
    public SPARQLTreeListModel<ClassModel> searchSubClasses(URI parent, String stringPattern, String lang, boolean excludeRoot) throws SPARQLException {
        try {
            return ontologyDAO.searchSubClasses(parent, ClassModel.class, stringPattern, lang, excludeRoot, null);
        } catch (Exception e) {
            throw new SPARQLException(e);
        }
    }
