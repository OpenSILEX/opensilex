...
/**
 * This class is the Data Transfer Object that is used when we update formSections.
 * Extends Section creation DTO as we only have a uri and an update date extra.
 *
