  ...
  <div>
    ...
    <div class="tables">
      <div class="table-left">
        <div>
          <div class="table-title">{{$t('component.experiment.form.groups-selection-list-title')}}</div>
          <b-table
            ref="tableRef"
            striped
            hover
      ...
      <div class="table-right">
        <div>
          <div
            class="table-title"
          >{{$t('component.experiment.form.groups-selected-list-title')}} ({{selectedTableData.length}})</div>
          <b-table
