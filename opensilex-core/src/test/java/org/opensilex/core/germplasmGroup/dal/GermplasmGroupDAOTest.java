...
public class GermplasmGroupDAOTest extends AbstractMongoIntegrationTest {
    ...
    public void beforeStuff() throws Exception {
        ...
        GermplasmModel pre1spe1Model = pre1spe1DTO.newModel(null, null, null);
        preSpecies1 = germplasmDAO.create(pre1spe1Model);
        GermplasmModel pre1spe2Model = pre1spe2DTO.newModel(null, null, null);
        ...
        GermplasmModel pre2spe1Model = pre2spe1DTO.newModel(null, null, null);
        pre2Species1 = germplasmDAO.create(pre2spe1Model);
        GermplasmModel pre2spe2Model = pre2spe2DTO.newModel(null, null, null);
