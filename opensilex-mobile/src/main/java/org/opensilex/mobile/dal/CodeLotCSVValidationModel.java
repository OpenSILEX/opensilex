...
/**
 * This class contains all the different types of errors that can be produced when we import code lots by csv.
 * Extends CSVValidationModel to have the basic information that's always required during any CSV import.
 *
