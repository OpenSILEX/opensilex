 ...
 * @update [Andreas Garcia] 19 Mar. 2019: make getAnnotations public to be able
 * to use it from another service.
...
public class AnnotationResourceService extends ResourceService {
     ...
     * @example [ { "motivatedBy": "http://www.w3.org/ns/oa#describing",
     * "creator":
     * "http://www.phenome-fppn.fr/diaphen/id/agent/arnaud_charleroy",
     * "comments": [ "commentary" ], "targets": [
     * "http://www.phenome-fppn.fr/diaphen/id/agent/arnaud_charleroy" ] } ]
     * @param context
     * @return
     */
     ...
     * 0, "totalCount": 297, "totalPages": 15 }, "status": [], "datafiles": []
     * }, "result": { "data": [ { "uri":
     ...
     * "creator":
     * "http://www.phenome-fppn.fr/diaphen/id/agent/arnaud_charleroy",
     * "creationDate": "2018-06-22 14:54:42+0200", "comments": [ "Ustilago
     * maydis infection" ], "targets": [
     * "http://www.phenome-fppn.fr/diaphen/id/agent/arnaud_charleroy" ] } ] } }
     * @param uri
