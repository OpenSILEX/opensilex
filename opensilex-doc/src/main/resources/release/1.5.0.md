...
# Connect to a console in OpenSILEX server
# From the directory which contains your OpenSILEX executable .jar file
java -jar opensilex.jar --CONFIG_FILE=<config_file> system run-update org.opensilex.migration.FacilitiesLinkToVariablesAndDevicesMigration
```

See the migration `org.opensilex.migration.FacilitiesLinkToVariablesAndDevicesMigration`
from [migration_command.md](../how-to/migration_command.md) for additional notes