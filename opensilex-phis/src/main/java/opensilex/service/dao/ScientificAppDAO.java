 ...
 */
public class ScientificAppDAO extends Rdf4jDAO<ScientificAppDescription> {

    public Session session;
    public String HOST_APP;
    public String PORT_APP;
    public String WS_HOST;

    public ScientificAppDAO(SPARQLService sparql) {
        super(sparql);
    }
    ...
    private ArrayList<ScientificAppDescription> getShinyProxyAppListFromDocumentMetadata(ArrayList<Document> documentsMetadata) {
        ...
        if (this.session != null) {
            sessionId = session.getOpenSilexUser().getToken();
        }
    ...
    private ArrayList<Document> listScientificAppMetadataFromTripleStore(String uri) {
        ...
        DocumentRdf4jDAO documentRdf4jDao = new DocumentRdf4jDAO(this.sparql);
