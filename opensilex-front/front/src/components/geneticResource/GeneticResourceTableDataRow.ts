...
export default class GeneticResourceTableDataRow {
  private data: any = {};

  /**
   * Flag to indicate if the line is for an update operation, i.e if the uri of the geneticResource already exists.
   */
