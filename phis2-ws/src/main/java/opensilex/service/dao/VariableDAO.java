...
public class VariableDAO extends Rdf4jDAO<Variable> {
     ...
     * @example SELECT DISTINCT ?uri ?label ?comment ?trait ?method ?unit WHERE
     * { GRAPH <http://www.phenome-fppn.fr/diaphen/variables> { ?uri
     * <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>
     * <http://www.opensilex.org/vocabulary/oeso#Variable> . ?uri
     * <http://www.w3.org/2000/01/rdf-schema#label> ?label . OPTIONAL { ?uri
     * <http://www.w3.org/2000/01/rdf-schema#comment> ?comment . } ?uri
     * <http://www.opensilex.org/vocabulary/oeso#hasTrait> ?trait . ?uri
     * <http://www.opensilex.org/vocabulary/oeso#hasMethod> ?method . ?uri
     * <http://www.opensilex.org/vocabulary/oeso#hasUnit> ?unit . } } LIMIT 20
     * OFFSET 40
     */
     ...
     *
     * @example SELECT DISTINCT (COUNT(DISTINCT ?uri) AS ?count) WHERE { GRAPH
     * <http://www.phenome-fppn.fr/diaphen/variables> { ?uri
     * <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>
     * <http://www.opensilex.org/vocabulary/oeso#Variable> . ?uri
     * <http://www.w3.org/2000/01/rdf-schema#label> ?label . OPTIONAL { ?uri
     * <http://www.w3.org/2000/01/rdf-schema#comment> ?comment . } ?uri
     * <http://www.opensilex.org/vocabulary/oeso#hasTrait> ?trait . ?uri
     * <http://www.opensilex.org/vocabulary/oeso#hasMethod> ?method . ?uri
     * <http://www.opensilex.org/vocabulary/oeso#hasUnit> ?unit . } }
     * @return Query generated to count the elements, with the searched
     * parameters
     */
    ...
    /**
     * Creates objects in the storage. The integrity check has to be done
     * previously.
     *
     * @param variablesDTO
     * @return
    ...
    /**
     * @param uri
     * @example SELECT DISTINCT ?property ?object ?seeAlso WHERE { GRAPH
     * <http://www.phenome-fppn.fr/diaphen/variables> {
     * <http://www.phenome-fppn.fr/diaphen/id/variables/v001> ?property ?object
     * . OPTIONAL { {?object <http://www.w3.org/2000/01/rdf-schema#seeAlso>
     * ?seeAlso} } FILTER ( (?property
     * IN(<http://www.w3.org/2008/05/skos#closeMatch>,
    ...
    public ArrayList<Variable> getAll(boolean usePagination, boolean withTraitMethodUnit) throws Exception {
        ...
        try (TupleQueryResult result = tupleQuery.evaluate()) {
            while (result.hasNext()) {
                ...
                if (trait != null) {
                    ...
                    variable.setTrait(new Trait(bindingSet.getValue(TRAIT).stringValue()));
                }

                if (method != null) {
                    variable.setMethod(new Method(method));
                } else {
                    variable.setMethod(new Method(bindingSet.getValue(METHOD).stringValue()));
                }
            ...
            LOGGER.error("Error while getting variables", ex);
            throw ex;
        }
        ...
        if (withTraitMethodUnit) {
            for (Variable variable : variables) {
                ...
                variable.setTrait(traitModel);
                variable.setMethod(methodModel);
                variable.setUnit(unitModel);
            }
        }
        return variables;
    }
     ...
     */
    public ArrayList<Variable> allPaginate() throws Exception {
     ...
     * @return objects found
     */
    public ArrayList<Variable> allPaginateDetails() throws Exception {
     ...
     *
     * <http://www.opensilex.org/vocabulary/oeso#Variable> . }
     * @return the query
     */
     ...
     *
     * @param uri
     * @return true if it is a variable false if not
     */
     ...
     *
     * @param uri
     * @return true if the URI corresponds to a variable false if it does not
     * exist or if it is not a variable
     */
     ...
     */
    public ArrayList<BrapiVariable> getBrapiVarData() throws Exception {
     ...
     *
     * @example SELECT DISTINCT ?label ?comment ?trait ?method ?unit WHERE {
     * GRAPH <http://www.phenome-fppn.fr/diaphen/variables> {
     * <http://www.phenome-fppn.fr/diaphen/id/variables/v004>
     * <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>
     * <http://www.opensilex.org/vocabulary/oeso#Variable> .
     * <http://www.phenome-fppn.fr/diaphen/id/variables/v004>
     ...
     * <http://www.phenome-fppn.fr/diaphen/id/variables/v004>
     * <http://www.opensilex.org/vocabulary/oeso#hasTrait> ?trait .
     * <http://www.phenome-fppn.fr/diaphen/id/variables/v004>
     * <http://www.opensilex.org/vocabulary/oeso#hasMethod> ?method .
     * <http://www.phenome-fppn.fr/diaphen/id/variables/v004>
     * <http://www.opensilex.org/vocabulary/oeso#hasUnit> ?unit . }}
     * @param uri
     * @return
