...
In this document we will use the keywords "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD", "SHOULD NOT", 
...
Some `Maven module` in OpenSilex are not `OpenSilex module` and exists just for technical or practical reasons.
