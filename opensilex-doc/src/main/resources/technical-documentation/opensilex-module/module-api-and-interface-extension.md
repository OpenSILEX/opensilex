...
A service should be at least in its own package and probably in its own module.

You should not have more than one service definition by module.

A service should be able to work with an every-time working configuration if possible.
