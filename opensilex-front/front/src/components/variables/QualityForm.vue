<template>
    ...
    <ValidationObserver ref="validatorRef">
        ...
        <!-- URI -->
        <b-form-group >
            <opensilex-FormInputLabelHelper label=component.variable.quality-uri helpMessage="component.variable.quality-uri-help"  ></opensilex-FormInputLabelHelper>
        ...
        <!-- Name -->
          <b-form-group  required>
              <opensilex-FormInputLabelHelper label=component.variable.quality-name helpMessage="component.variable.quality-name-help" >
              </opensilex-FormInputLabelHelper>
              <ValidationProvider 
                :name="$t('component.variable.quality-name')" 
                rules="required"
                v-slot="{ errors }"
              >                
              <b-form-input id="label"  v-model="form.label"
                  :placeholder="$t('component.variable.quality-name-placeholder')" >
              </b-form-input>
              <div class="error-message alert alert-danger">{{ errors[0] }}</div>
              </ValidationProvider>
          </b-form-group>
...
export default class QualityForm extends Vue {
    ...
    showCreateForm() {
        this.title = this.$t("component.variable.form.add.quality").toString();
