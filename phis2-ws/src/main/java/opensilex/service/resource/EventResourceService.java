 ...
 * @update [Andréas Garcia] 8 Apr. 2019: Refactor generic functions into the
...
public class EventResourceService extends ResourceService {
     ...
     * "concernedItems": [ { "labels": [ "label2", "label3" ], "uri":
     * "http://www.phenome-fppn.fr/m3p/arch/2017/c17000241", "typeUri":
     * "http://www.opensilex.org/vocabulary/oeso#Thermocouple" } ], "date":
     * "2017-09-11T12:00:00+01:00", "properties": [ { "rdfType":
     * "http://www.opensilex.org/vocabulary/oeso#Thermocouple", "relation":
     * "http://www.phenome-fppn.fr/vocabulary/2018/oeev#from", "value":
...
=======
            ...
            @ApiParam(
                    ...
                    example = DocumentationAnnotation.EXAMPLE_EVENT_SEARCH_END_DATE)
            @QueryParam("endDate")
>>>>>>> 51335dd4c3bbf930ea12f49a1b2420279bb87ec8
     ...
     * "concernedItems": [ { "labels": [ "Parcelle Lavalette", "Plot Lavalette"
     * ], "uri": "http://www.opensilex.org/ues/2018/o18000124", "typeURI":
     * "http://www.opensilex.org/vocabulary/oeso#Plot" } ], "date":
     * "2017-09-08T12:00:00+01:00", "properties": [ { "rdfType": null,
     * "relation": "http://www.opensilex.org/vocabulary/oeev#hasPest", "value":
     * "http://aims.fao.org/aos/agrovoc/c_34724" } ] } ] } }
     * @param uri
     ...
     * @param page
     * @example [ { "uri":
     * "http://www.opensilex.org/phenome-fppn/id/annotation/896325c3-85f7-4ad3-bf96-34ba497108c3",
     * "creationDate": "2019-03-11T09:40:03+01:00", "creator":
     * "http://www.phenome-fppn.fr/diaphen/id/agent/admin_phis", "motivatedBy":
     * "http://www.w3.org/ns/oa#describing", "bodyValues": [ "fth" ], "targets":
     * [
     ...
     *
     * @example { [ { "rdfType":
     * "http://www.opensilex.org/vocabulary/oeev#MoveFrom", "description": "The
     * pest attack lasted 20 minutes", "creator":
     * "http://www.phenome-fppn.fr/diaphen/id/agent/marie_dupond",
     * "concernedItemsUris": [ "string" ], "date": "2017-09-08T12:00:00+01:00",
     * "properties": [ { "rdfType": "http://xmlns.com/foaf/0.1/Agent",
     * "relation": "http://www.phenome-fppn.fr/vocabulary/2018#hasContact",
     * "value": "http://www.phenome-fppn.fr/diaphen/id/agent/marie_dupond" } ] }
     * ] }
     * @param eventsDtos
     * @param context
     * @return The found errors The list of the URIs of the created events
     */
    @POST
