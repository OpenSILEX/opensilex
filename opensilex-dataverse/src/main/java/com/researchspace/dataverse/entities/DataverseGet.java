...
public class DataverseGet {
	 ...
	 */
	@SuppressWarnings("all")
	public List<Object> getDataverseContacts() {
	 ...
	 */
	@SuppressWarnings("all")
	public void setDataverseContacts(final List<Object> dataverseContacts) {
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof DataverseGet)) return false;
		final DataverseGet other = (DataverseGet) o;
	...
	protected boolean canEqual(final Object other) {
		return other instanceof DataverseGet;
	}
	...
	public String toString() {
		return "DataverseGet(id=" + this.getId() + ", alias=" + this.getAlias() + ", name=" + this.getName() + ", affiliation=" + this.getAffiliation() + ", permissionRoot=" + this.getPermissionRoot() + ", description=" + this.getDescription() + ", ownerId=" + this.getOwnerId() + ", creationDate=" + this.getCreationDate() + ", dataverseContacts=" + this.getDataverseContacts() + ")";
	}
}
