...
public class ImageResourceService extends ResourceService {
    ...
    public Response getImagesBySearch(
        ...
        @ApiParam(value = "Search by interval - start date", example = DocumentationAnnotation.EXAMPLE_IMAGE_DATE) @QueryParam("startDate") @opensilex.service.resources.validation.interfaces.Date(DateFormat.YMDHMSZ) String startDate,
