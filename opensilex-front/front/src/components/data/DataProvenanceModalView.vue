...
export default class DataProvenanceModalView extends Vue {
  ...
  created() {
    ...
    // this.getDataFileDescription()
  }

  // setProvenance(value){
  //   console.log("value.data", value.data)
  //   this.data = JSON.stringify(value.data, null, 2);
  //       console.log("this.data apr: " ,this.data)
  ...
  setProvenance(value) {
    ...
    if (value.data.provenance.prov_used!= undefined && value.data.provenance.prov_used != null) {
    // this.getDataFileImage(value)
     console.log(value)
    this.showImage(value.data.provenance.prov_used[0])
    this.getDataFileDescription(value)
  ...
  // @Watch('showProvUsedModal')
  // onshowProvUsedModalChanged(newVal: boolean) {
  //   if (newVal) {
  //     this.modalText = this.value.data.provenance.prov_used
  //       ? this.value.data.provenance.prov_used[0].uri
  //       : 'null';
  //   }
  // }
