  ...
  <ValidationObserver ref="validatorRef">
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        ></opensilex-SelectForm>
        <opensilex-EntityCreate ref="entityForm" @onCreate="setLoadedEntity"></opensilex-EntityCreate>
      </div>
      ...
      <div class="col-lg-6">
        ...
        ></opensilex-SelectForm>
        <opensilex-QualityCreate ref="qualityForm" @onCreate="setLoadedQuality"></opensilex-QualityCreate>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        ></opensilex-SelectForm>
        <opensilex-MethodCreate ref="methodForm" @onCreate="setLoadedMethod"></opensilex-MethodCreate>
      </div>
      ...
      <div class="col-lg-6">
        ...
        ></opensilex-SelectForm>
        <opensilex-UnitCreate ref="unitForm" @onCreate="setLoadedUnit"></opensilex-UnitCreate>
      </div>
    </div>
...
export default class VariableForm1 extends Vue {
  ...
  getLabel(dto: any, dtoList: Array<NamedResourceDTO>): string {
    ...
    let returnedDto: NamedResourceDTO = dtoList.find(
      dtoElem => dtoElem.uri == dto
    );
    if (returnedDto) {
  ...
  searchEntities(name: string, page, pageSize) {
    return this.service
      .searchEntities(name, ["name=asc"], page, pageSize)
      .then(
    ...
    return [
      {
        id: dataType.uri,
        label:
          dataType.labelKey.charAt(0).toUpperCase() + dataType.labelKey.slice(1)
      }
    ];
  }
