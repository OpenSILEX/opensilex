...
public class EventDAOSesame extends DAOSesame<Event> {
    ...
    /**
     * Generates the query to get the uri and the label of the events
     * @example
     * SELECT DISTINCT  ?uri ?label WHERE {
     *      ?uri  rdf:type  <http://www.phenome-fppn.fr/vocabulary/2018/oeev#Event> . 
    ...
    protected SPARQLQueryBuilder prepareSearchQuery() {
        ...
        query.appendTriplet(select, Rdf.RELATION_TYPE.toString(), Vocabulary.CONCEPT_EVENT.toString(), null);
