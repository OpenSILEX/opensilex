...
public class AnnotationDAOSesame extends DAOSesame<Annotation> {
    ...
    /**
     * Query generated by the searched parameters above (uri, creator, motivatedBy, bodyValue). 
     * .e.g.
     * SELECT DISTINCT ?uri
     * WHERE { 
    ...
    /**
     * Count query generated by the searched parameters above (uri, creator, motivatedBy, bodyValue).
    ...
    /**
     * generates an insert query for annotations. e.g. 
     * INSERT DATA {
    ...
    /**
     * search all the annotations corresponding to the search params given by the user (uri, creator, motivatedBy, bodyValue)
     *
     * @return the list of the annotations which match the given search params (uri, creator, motivatedBy, bodyValue).
     */
