...
// GeneticResource
import GeneticResourceView from './geneticResource/GeneticResourceView.vue';
components["opensilex-GeneticResourceView"] = GeneticResourceView;
import GeneticResourceForm from './geneticResource/GeneticResourceForm.vue';
components["opensilex-GeneticResourceForm"] = GeneticResourceForm;
import GeneticResourceList from './geneticResource/GeneticResourceList.vue';
components["opensilex-GeneticResourceList"] = GeneticResourceList;
import GeneticResourceCreate from './geneticResource/GeneticResourceCreate.vue';
components["opensilex-GeneticResourceCreate"] = GeneticResourceCreate;
import GeneticResourceTable from './geneticResource/GeneticResourceTable.vue';
components["opensilex-GeneticResourceTable"] = GeneticResourceTable;
import GeneticResourceDetails from './geneticResource/GeneticResourceDetails.vue';
components["opensilex-GeneticResourceDetails"] = GeneticResourceDetails;
import GeneticResourceModalList from './geneticResource/GeneticResourceModalList.vue';
components["opensilex-GeneticResourceModalList"] = GeneticResourceModalList;
import AttributesTable from './common/forms/AttributesTable.vue';
components["opensilex-AttributesTable"] = AttributesTable;
import GeneticResourcePropertyView from './geneticResource/GeneticResourcePropertyView.vue';
components["opensilex-GeneticResourcePropertyView"] = GeneticResourcePropertyView;
import GeneticResourcePropertySelector from './geneticResource/GeneticResourcePropertySelector.vue';
components["opensilex-GeneticResourcePropertySelector"] = GeneticResourcePropertySelector;
import GeneticResourceHelp from './geneticResource/GeneticResourceHelp.vue';
components["opensilex-GeneticResourceHelp"] = GeneticResourceHelp;
import GeneticResourceSelector from './geneticResource/GeneticResourceSelector.vue';
components["opensilex-GeneticResourceSelector"] = GeneticResourceSelector;
import GeneticResourceAttributesSelector from './geneticResource/GeneticResourceAttributesSelector.vue';
components["opensilex-GeneticResourceAttributesSelector"] = GeneticResourceAttributesSelector;
import GeneticResourceGroup from './geneticResourceGroup/GeneticResourceGroup.vue';
components["opensilex-GeneticResourceGroup"] = GeneticResourceGroup;
import GeneticResourceGlobalView from './geneticResource/GeneticResourceGlobalView.vue';
components["opensilex-GeneticResourceGlobalView"] = GeneticResourceGlobalView;
import GeneticResourceGroupStructureDetails from './geneticResourceGroup/GeneticResourceGroupStructureDetails.vue';
components["opensilex-GeneticResourceGroupStructureDetails"] = GeneticResourceGroupStructureDetails;
import GroupGeneticResourceForm from './geneticResourceGroup/GroupGeneticResourceForm.vue';
components["opensilex-GroupGeneticResourceForm"] = GroupGeneticResourceForm;
import GeneticResourceGroupList from './geneticResourceGroup/GeneticResourceGroupList.vue';
components["opensilex-GeneticResourceGroupList"] = GeneticResourceGroupList;
import GeneticResourceSelectorWithFilter from './geneticResource/GeneticResourceSelectorWithFilter.vue';
components["opensilex-GeneticResourceSelectorWithFilter"] = GeneticResourceSelectorWithFilter;
import GeneticResourceGroupContentList from './geneticResourceGroup/GeneticResourceGroupContentList.vue';
components["opensilex-GeneticResourceGroupContentList"] = GeneticResourceGroupContentList;
import GeneticResourceGroupSelector from './geneticResourceGroup/GeneticResourceGroupSelector.vue';
components["opensilex-GeneticResourceGroupSelector"] = GeneticResourceGroupSelector;
import AssociatedGeneticResourceGroupsList from './geneticResourceGroup/AssociatedGeneticResourceGroupsList.vue';
components["opensilex-AssociatedGeneticResourceGroupsList"] = AssociatedGeneticResourceGroupsList;
import GeneticResourceGroupHelp from './geneticResourceGroup/GeneticResourceGroupHelp.vue';
components["opensilex-GeneticResourceGroupHelp"] = GeneticResourceGroupHelp;
import GeneticResourceAttributesValueSelector from './geneticResource/GeneticResourceAttributesValueSelector.vue';
components["opensilex-GeneticResourceAttributesValueSelector"] = GeneticResourceAttributesValueSelector;
import GeneticResourceAddColumnModal from './geneticResource/addColumnComponents/GeneticResourceAddColumnModal.vue';
components["opensilex-GeneticResourceAddColumnModal"] = GeneticResourceAddColumnModal;
import GeneticResourceControlledAttributesSelector from './geneticResource/addColumnComponents/GeneticResourceControlledAttributesSelector.vue';
components["opensilex-GeneticResourceControlledAttributesSelector"] = GeneticResourceControlledAttributesSelector;
import GeneticResourceParentsModalFormField from './geneticResource/GeneticResourceParentsModalFormField.vue';
components["opensilex-GeneticResourceParentsModalFormField"] = GeneticResourceParentsModalFormField;
import GeneticResourceParentsModalFormFieldLine from './geneticResource/GeneticResourceParentsModalFormFieldLine.vue';
components["opensilex-GeneticResourceParentsModalFormFieldLine"] = GeneticResourceParentsModalFormFieldLine;
