...
<script lang="ts">
    ...
    export default class MoveForm extends Vue {
        ...
        handleSubmitError(){
            if(!this.form.to && (Object.values(this.form.targets_positions[0].position).every(value => !value))){
...
fr:
    Move:
        ...
        requiredFieldInformation: Au moins l'un des champs suivant doit être renseigné pour déclarer l'élément
</i18n>
