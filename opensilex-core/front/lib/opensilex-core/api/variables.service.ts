...
export class VariablesService {
     ...
     */
    public create2(Authorization: string, body?: EntityCreationDTO, observe?: 'body', headers?: Headers): Observable<any>;
    public create2(Authorization: string, body?: EntityCreationDTO, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public create2(Authorization: string, body?: EntityCreationDTO, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (!Authorization){
     ...
     */
    public create3(Authorization: string, body?: MethodCreationDTO, observe?: 'body', headers?: Headers): Observable<any>;
    public create3(Authorization: string, body?: MethodCreationDTO, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public create3(Authorization: string, body?: MethodCreationDTO, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (!Authorization){
     ...
     */
    public create4(Authorization: string, body?: QualityCreationDTO, observe?: 'body', headers?: Headers): Observable<any>;
    public create4(Authorization: string, body?: QualityCreationDTO, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public create4(Authorization: string, body?: QualityCreationDTO, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (!Authorization){
     ...
     */
    public create5(Authorization: string, body?: UnitCreationDTO, observe?: 'body', headers?: Headers): Observable<any>;
    public create5(Authorization: string, body?: UnitCreationDTO, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public create5(Authorization: string, body?: UnitCreationDTO, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (!Authorization){
     ...
     */
    public create6(Authorization: string, body?: VariableCreationDTO, observe?: 'body', headers?: Headers): Observable<any>;
    public create6(Authorization: string, body?: VariableCreationDTO, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public create6(Authorization: string, body?: VariableCreationDTO, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (!Authorization){
            throw new Error('Required parameter Authorization was null or undefined when calling create6.');
        }
