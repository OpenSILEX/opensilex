  ...
  <b-modal ref="modalRef" @ok.prevent="validate" size="xl" :static="true">
    ...
    <ValidationObserver ref="validatorRef">
      <b-form>
        <!-- URI -->
        <b-form-group>
          <ValidationProvider vid="autogeneratedDevice">
            <b-form-checkbox
              v-if="!editMode"
              id="autogeneratedDevice"
              v-model="uriGenerated"
              name="autogeneratedDevice"
            >
              <opensilex-FormInputLabelHelper
                label="component.infrastructure.device-uri"
          ...
          <ValidationProvider
            name="uridevice"
            rules="required_if:autogeneratedDevice,false|url"
            v-slot="{ errors }"
          >
            <b-form-input
              id="uridevice"
