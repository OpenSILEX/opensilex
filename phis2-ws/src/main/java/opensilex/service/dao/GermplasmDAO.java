...
public class GermplasmDAO extends Rdf4jDAO<Germplasm> {
    ...
    public GermplasmDAO(SPARQLService sparql, String uri) {
        super(sparql);
        this.uri = uri;
    }
    ...
    public POSTResultsReturn check(List<Germplasm> germplasms) {
        ...
        List<String> germplasmTypesCache = new ArrayList<>();
        List<String> fromGenusCache = new ArrayList<>();
        List<String> fromSpeciesCache = new ArrayList<>();
    ...
    public POSTResultsReturn insert(List<Germplasm> germplasms) throws Exception {
        ...
        for (Germplasm germplasm : germplasms) {
            if (germplasm.getUri() == null) {
                germplasm.setUri(UriGenerator.generateNewInstanceUri(sparql, germplasm.getRdfType(), null, germplasm.getLabel()));
            }
     ...
     * <http://www.phenome-fppn.fr/platform/germplasm> {
     * <http://www.phenome-fppn.fr/platform/id/germplasm/g001> rdf:type
     *  <http://www.opensilex.org/vocabulary/oeso#Germplasm> .
     * <http://www.phenome-fppn.fr/platform/id/germplasm/g001> rdfs:label
     * "B73_INRA" .
     * <http://www.phenome-fppn.fr/platform/id/germplasm/g001>
     *  <http://www.opensilex.org/vocabulary/oeso#hasGenus> "Zea" .
     * <http://www.phenome-fppn.fr/platform/id/germplasm/g001>
     *  <http://www.opensilex.org/vocabulary/oeso#hasSpecies>
     * "http://aims.fao.org/aos/agrovoc/c_12332" .
     * <http://www.phenome-fppn.fr/platform/id/germplasm/g001>
     *  <http://www.opensilex.org/vocabulary/oeso#hasVariety> "B73" .
     * <http://www.phenome-fppn.fr/platform/id/germplasm/g001>
     *  <http://www.opensilex.org/vocabulary/oeso#hasAccessionNumber> "B73_INRA"
     * . } }
     * @param accession
     * @return the query
     */
     ...
     * @param species
     * @param variety
     * @example SELECT DISTINCT (count(distinct ?uri) as ?count) WHERE { ?uri ?0
     * ?rdfType . ?rdfType rdfs:subClassOf*
     *  <http://www.opensilex.org/vocabulary/oeso#SensingDevice> . OPTIONAL {
     * ?uri rdfs:label ?label . } ?uri
     *  <http://www.opensilex.org/vocabulary/oeso#hasBrand> ?brand . OPTIONAL {
     * ?uri <http://www.opensilex.org/vocabulary/oeso#hasSerialNumber>
     * ?serialNumber . } OPTIONAL { ?uri
     * <http://www.opensilex.org/vocabulary/oeso#inServiceDate> ?inServiceDate .
     * } OPTIONAL { ?uri
     * <http://www.opensilex.org/vocabulary/oeso#dateOfPurchase> ?dateOfPurchase
     * . } OPTIONAL { ?uri
     * <http://www.opensilex.org/vocabulary/oeso#dateOfLastCalibration>
     * ?dateOfLastCalibration . } ?uri
     *  <http://www.opensilex.org/vocabulary/oeso#personInCharge>
     * ?personInCharge . }
    ...
    /**
     * Gets a accession from a given binding set. Assume that the following
     * attributes exist : uri, accessionName, accessionNumber, species, variety
     *
    ...
    /**
     * Gets a germplasmDTO from a given binding set. Assume that the following
     * attributes exist : uri, accessionName, accessionNumber, species, variety
     *
     * @param bindingSet a bindingSet from a search query
     * @param uri
