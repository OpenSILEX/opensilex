...
public class GeneticResourceAPITest extends FaidareAPITest {
    protected static final ServiceDescription search;

    static {
        try {
            search = new ServiceDescription(
                    GeneticResourceAPI.class.getMethod("getGeneticResourcesBySearch", URI.class, URI.class, String.class, int.class, int.class),
                    "/faidare/v1/geneticResource"
            );
