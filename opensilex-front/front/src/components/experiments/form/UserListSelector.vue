...
export default class UserListSelector extends Vue {
  ...
  toggleUserSelection(user) {
    ...
    console.log("toggleUserSelection :"+user.uri);
    if (!this.selectedUsers[user.uri]) {
      console.log("toggleUserSelection new :"+user.uri);
      this.selectedUsers[user.uri] = true;
      this.selectedTableData.push(user.uri);
    } else {
      this.unselectUserProfile(user);
    }
  }

  unselectUserProfile(user) {
    ...
    this.selectedUsers[user.uri] = false;
  }
}
</script>
