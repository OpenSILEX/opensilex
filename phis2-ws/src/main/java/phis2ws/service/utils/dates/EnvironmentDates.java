...
// Subject: Classes which represents the environment dates. With this class we can 
// check if a date format corresponds to the environment authorized formats.
//******************************************************************************
...
/**
 * represents the environment dates. Manipulates thoses dates (e.g. check formats)
...
public class EnvironmentDates extends Dates {
     ...
     * @author Arnaud Charleroy
     * @see phis2ws.service.configuration.DateFormats AUTHORIZED_USER_ENVIRONMENT_DATE_FORMATS
