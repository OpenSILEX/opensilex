...
public class VariableResourceService extends ResourceService {
    ...
    /**
     * Get list of variable according to the given search parameters if
     * withDetail is set to true, it will return variables with all traits,
     * metods and units proeprties
     *
     * @param pageSize
     * @param page
     * @param uri
