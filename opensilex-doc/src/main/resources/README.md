OpenSILEX developer documentation
====================================

# Overview

This repository contains OpenSILEX's technical and user documentation.

# Background

OpenSILEX is a collaborative meta-project developed at MISTEA joint research unit (INRAE - SupAgro) at [MISTEA web page](https://www6.montpellier.inra.fr/mistea).
...
Contains general information on how to install and configure OpenSILEX :
...
This contains usefully documentation for developers.
Here you can find large subject like geospatial location model as well as specific technical documentation like germplasm import.

## [functional-specifications](functional-specifications)

This contains functional specifications for each OpenSILEX elements ( experiments, scientific objects, ... ).
A functional specification is a very detailed set of rules and behaviors that the OpenSILEX API is intended to follow.
