...
public interface MongoWriteDao<T extends MongoModel, F extends MongoSearchFilter> {
     ...
     */
    InsertOneResult create(T instance) throws MongoException, URISyntaxException, NoSQLAlreadyExistingUriException;
     ...
     * @throws URISyntaxException If the provided URI is invalid.
     */
    InsertOneResult create(T instance, ClientSession session) throws MongoException, URISyntaxException, NoSQLAlreadyExistingUriException;
     ...
     * @throws URISyntaxException If the provided URI is invalid.
     */
    InsertManyResult create(List<T> instances) throws MongoException, URISyntaxException, NoSQLAlreadyExistingUriException;
     ...
     * @throws URISyntaxException If the provided URI is invalid.
     */
    InsertManyResult create(List<T> instances, ClientSession session) throws MongoException, URISyntaxException, NoSQLAlreadyExistingUriException;
     ...
     * @throws MongoException If a MongoDB error occurs.
     */
    void update(T instance) throws MongoException, NoSQLInvalidURIException;
     ...
     * @throws MongoException If a MongoDB error occurs.
     */
    void update(T instance, ClientSession session) throws MongoException, NoSQLInvalidURIException;
