...
public class BrapiTraitDAO extends DAOSesame<BrapiTrait> {
    ...
    //the uri of trait e.g. http://www.phenome-fppn.fr/platform/id/traits/t001
    ...
    protected SPARQLQueryBuilder prepareSearchQuery(BrapiTrait trait) {
        /**
        ...
        */
        ...
        query.appendTriplet("?varUri", Vocabulary.RELATION_HAS_TRAIT.toString(),trait.getTraitDbId(), null);   
        return(query);
    }
    ...
    private ArrayList<BrapiTrait> getVariables(ArrayList<BrapiTrait> traits){                
        for (BrapiTrait bt:traits) {
            SPARQLQueryBuilder query = prepareSearchQuery(bt);
    ...
    public ArrayList<BrapiTrait> allPaginate() {
        ...
        //fill brapiTraits attributes with the traits attributes gotten from traitDAO
        for (Trait tr:traits) {
