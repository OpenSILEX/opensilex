...
public class AnnotationDAOSesame extends DAOSesame<Annotation> {
     ...
     * motivatedBy, bodyValue). .e.g. SELECT DISTINCT ?uri WHERE { ?uri
     * <http://purl.org/dc/terms/creationDate> ?creationDate . ?uri
     * <http://purl.org/dc/terms/creator> ?creator . ?uri
     * <http://www.w3.org/ns/oa#motivatedBy> ?motivatedBy . ?uri
     * <http://www.w3.org/ns/oa#bodyValue> ?bodyValue . } LIMIT 20
     *
     ...
     * ?count) WHERE { ?uri <http://purl.org/dc/terms/creationDate>
     * ?creationDate . ?uri <http://purl.org/dc/terms/creator>
     ...
     * regex(STR(?bodyValue), 'Ustilago maydis infection', 'i') ) }
     *
     ...
     * <http://www.phenome-fppn.fr/platform/id/annotation/a2f9674f-3e49-4a02-8770-e5a43a327b37>
     * <http://purl.org/dc/terms/creationDate> "2018-06-22
     * 15:18:13+0200"^^xsd:dateTime .
     * <http://www.phenome-fppn.fr/platform/id/annotation/a2f9674f-3e49-4a02-8770-e5a43a327b37>
