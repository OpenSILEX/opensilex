 ...
 */
public class ProjectPostgresDTO extends AbstractVerifiedClass {

    final static Logger LOGGER = LoggerFactory.getLogger(ProjectPostgresDTO.class);
    ...
    public ProjectPostgres createObjectFromDTO() {
        ProjectPostgres project = new ProjectPostgres(uri);
